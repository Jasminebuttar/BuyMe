...
<h1><center>Earning Report as per Carrier</center></h1>
<%
	...
	String str = "SELECT SUM(max) as sum, carrier "+ 
				 "FROM (SELECT MAX(b.amount) as max, b.auctionid, a.carrier "+ 
				 "FROM Bid b INNER JOIN Auction a ON b.auctionid = a.auctionid "+
				 "WHERE a.enddate <= NOW() GROUP BY auctionid) as sales "+
		         "GROUP BY carrier ORDER BY " + sortBy + " " + order;
