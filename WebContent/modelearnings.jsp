...
<% //Get the database connection
	...
	String str = "SELECT SUM(max) as sum, brand, model "+ 
				 "FROM (SELECT MAX(b.amount) as max, b.auctionid, a.brand, a.model "+ 
				 "FROM Bid b INNER JOIN Auction a ON b.auctionid = a.auctionid "+
				 "WHERE a.enddate <= NOW()) as sales "+
		         "GROUP BY model ORDER BY " + sortBy + " " + order;
